                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">{{ __('message.loginSystem') }}</h1>
                                </div>
                                <form class="user" action="{{ route('admin.postLogin') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox small">
                                            ...
                                            <label class="custom-control-label" for="customCheck">{{ __('message.remember') }}</label>
                                        </div>
                                    </div>
                                    <input type="submit" value="{{ __('message.login') }}" class="btn btn-primary btn-user btn-block">
                                </form>
                            </div>
                        </div>
                    </div>

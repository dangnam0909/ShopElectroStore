                ...
                <div class="col-md-3 col-sm-6 footer-grids w3l-agileits mt-md-0 mt-4">
                    ...
                    <div class="footer-grids  w3l-socialmk mt-3">
                        ...
                        <div class="social">
                            <ul>
                                <li>
                                    <a class="icon fb" href="https://facebook.com/rooneynam91" target="_blank">
                                        <i class="fab fa-facebook-f"></i>
                                    </a>
                                </li>
                                <li>
                                    <a class="icon tw" href="https://twitter.com/namdangnguyen09" taget="_blank">
                                        <i class="fab fa-twitter"></i>
                                    </a>
                                </li>
                                <li>
                                    <a class="icon gp" href="https://plus.google.com/" target="_blank">
...
<div class="copy-right py-3">
    <div class="container">
        <p class="text-center text-white">© 2020 Electro Store. All rights reserved | Design by
            <a href="http://facebook.com/rooneynam91" target="_blank">NamDangNguyen<sup style="font-size: 14px;">&reg;</sup></a>
        </p>
    </div>
</div>
<!-- //copyright -->
